...
{% else %}
  ...
  повідомити будь-яку інформацію, яка може бути корисною для того, щоб зробити ваш досвід в Carpentries більш доступним, <a href="mailto:team@carpentries.org">напишіть нам електронною поштою</a>.
</p>
{% endif %}
