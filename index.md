...
venue: "Національний технічний університет «Дніпровська політехніка»"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
language: "uk"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for the workshop
...
humandate: "20-21 січня 2026 р"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "10:00 - 17:00 за київським часом"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2026-01-20      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2026-01-21        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Юрій Клебан", "Олександр Коновалов"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Роман Ілюшин", "Ірина Раєвська", "Марина Раєвська", "Богдана Стрелюк", "Володимир Харченко", "Вероніка Шевченко"] # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["obk1@st-andrews.ac.uk"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
<p>
<strong><a href="https://carpentries.org">The Carpentries</a></strong> - це міжнародний волонтерський проєкт, який допомагає науковцям вивчити сучасні навички,
...
{% else %}
  ...
  повідомити будь-яку інформацію, яка може бути корисною для того, щоб зробити ваш досвід в Carpentries більш доступним, <a href="mailto:obk1@st-andrews.ac.uk">напишіть нам електронною поштою</a>.
</p>
{% endif %}
